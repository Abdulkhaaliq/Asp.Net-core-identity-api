...
namespace AuthenticationAndPostingApi.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<IActionResult> Register([FromBody]UserProfile userProfile)
        {
            ...
            var identityUser = new IdentityUser() { UserName = userProfile.UserName, Email = userProfile.Email};
            var result = await userManager.CreateAsync(identityUser, userProfile.Password);
            if (!result.Succeeded)
            {
